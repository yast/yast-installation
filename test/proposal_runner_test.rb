...
describe ::Installation::ProposalRunner do
  ...
  describe "#run" do
    ...
    let(:keyboard_description) do
      { "id" => "keyboard_stuff", "menu_title" => "&Keyboard Layout",
"rich_text_title" => "Keyboard Layout" }
    ...
    describe "#html_header" do
      it "returns clickable header when forced" do
        ...
        expect(subject.send(:html_header, "software",
          force_rw: true)).to eql Yast::HTML.Heading(Yast::HTML.Link("Software", "software"))
      end
    end
